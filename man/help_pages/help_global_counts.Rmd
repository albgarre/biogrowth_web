---
title: "Input for global fitting"
author: ""
date: ""
output: md_document
---
...
The user must input the observed microbial counts during each one of the experiments.. These are defined using an MS Excel file with the following restrictions:

* The data of each experiment must be contained in a single Excel sheet.
...
* Each sheet must contain a column named `time` including the elapsed time.
* Each sheet must contain a column named `logN` including the observed log10-microbial count.
