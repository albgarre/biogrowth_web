...
The user must input the (dynamic) environmental conditions during each one of the experiments.. These are defined using an MS Excel file with the following restrictions:
